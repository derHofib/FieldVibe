      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-2 gap-2">
          {highlights!.map((h) => (
            <div
              key={h.id}
              className="card-interactive group relative overflow-hidden rounded-lg bg-white shadow-xs dark:bg-stone-900 dark:shadow-none dark:ring-1 "
            >
              <button
              ...
              >
                ...
                <div className="p-2">
                  <div className="line-clamp-1 text-xs font-medium text-label">
                    {h.titel ?? h.vorgang_titel}
                  </div>
                  <div className="text-xs text-label2">{h.vorgangsnummer}</div>
                </div>
              </button>
