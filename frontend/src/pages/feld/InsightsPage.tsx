...
function Kachel({ label, wert }: { label: string; wert: string }) {
  return (
    <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-slate-900 dark:shadow-none dark:ring-1 dark:ring-slate-800">
      ...
      <div className="mt-1 text-2xl font-bold text-slate-800 dark:text-slate-100">{wert}</div>
    </div>
  );
}
...
export function InsightsPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-slate-900 dark:shadow-none dark:ring-1 dark:ring-slate-800">
        <h2 className="mb-2 text-sm font-semibold text-slate-500 dark:text-slate-400">Vorgänge nach Status</h2>
      ...
      <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-slate-900 dark:shadow-none dark:ring-1 dark:ring-slate-800">
        ...
        {insights.techniker_auslastung.length === 0 ? (
          <p className="text-sm text-slate-400 dark:text-slate-500">Keine Techniker erfasst.</p>
        ) : (
          <div className="space-y-1.5">
      ...
      <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-slate-900 dark:shadow-none dark:ring-1 dark:ring-slate-800">
        <h2 className="mb-2 text-sm font-semibold text-slate-500 dark:text-slate-400">Export</h2>
