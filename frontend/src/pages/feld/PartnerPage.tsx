...
export function PartnerPage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-lg font-bold text-label">Partner &amp; Nachunternehmer</h1>
      ...
      {showForm && (
        <div className="space-y-3 border border-sep bg-card p-4">
          ...
          <div>
            <label className="mb-1 block text-xs text-label2">Telefon</label>
            <input
          ...
          <div>
            <label className="mb-1 block text-xs text-label2">E-Mail</label>
            <input
              type="email"
      ...
      <div className="space-y-2">
        ...
        {isLoading ? (
          ...
          partnerGefiltert.map((p) => (
            ...
            >
              <div>
                <div className="text-sm font-medium text-label">{p.name}</div>
                {p.gewerk && (
                  <div className="text-xs text-label2">{p.gewerk}</div>
                )}
              </div>
              {!p.aktiv && (
