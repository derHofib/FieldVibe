...
function SettingsLink({
  ...
  return (
    <button
      onClick={onClick}
      className="card-interactive btn-touch flex w-full items-center gap-3 rounded-lg bg-white p-4 text-left shadow-xs dark:bg-stone-900 dark:shadow-none dark:ring-1 dark:ring-stone-800"
    >
